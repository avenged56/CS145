...
public class MainWindow {
	...
	protected void createContents() {
		...
		friendsListView.setBounds(94, 83, 128, 225);
	...
	private class AddButtonSelection extends SelectionAdapter {
		...
		@Override
		public void widgetSelected(SelectionEvent e) {
			String newFriend = lastNameText.getText() + ", " + firstNameText.getText();
			friendsListView.add(newFriend);
		}
	}
