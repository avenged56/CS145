...
public class MainWindow {
	...
	protected void createContents() {
		...
		Label firstNameLabel = new Label(clientArea, SWT.NONE);
		firstNameLabel.setBounds(10, 10, 62, 15);
		firstNameLabel.setText("First Name");

		Label lastNameLabel = new Label(clientArea, SWT.NONE);
		lastNameLabel.setBounds(10, 42, 62, 15);
		lastNameLabel.setText("Last Name");

		Label friendsLabel = new Label(clientArea, SWT.NONE);
		friendsLabel.setBounds(10, 74, 62, 15);
		friendsLabel.setText("Friends");

		firstNameText = new Text(clientArea, SWT.BORDER);
		firstNameText.setBounds(94, 10, 128, 21);

		lastNameText = new Text(clientArea, SWT.BORDER);
		lastNameText.setBounds(94, 42, 128, 21);

		Button addButton = new Button(clientArea, SWT.NONE);
		addButton.addSelectionListener(new AddButtonSelection());
		addButton.setBounds(228, 42, 75, 25);
		addButton.setText("Add");

		friendsListView = new List(clientArea, SWT.BORDER);
		friendsListView.addSelectionListener(new FriendsListViewSelection());
		friendsListView.setBounds(94, 75, 128, 225);

		Button deleteButton = new Button(clientArea, SWT.NONE);
		deleteButton.addSelectionListener(new DeleteButtonSelection());
		deleteButton.setBounds(228, 74, 75, 25);
	...
	private class AddButtonSelection extends SelectionAdapter {
	...
	private class FriendsListViewSelection extends SelectionAdapter {

		@Override
		public void widgetSelected(SelectionEvent e) {
			int selection = friendsListView.getSelectionIndex();
			String currentString = new String(friends.get(selection).toString());
			String splitArray[] = currentString.split("[,]");
			firstNameText.setText(splitArray[1].trim());
			lastNameText.setText(splitArray[0].trim());
		}
	}


	private class DeleteButtonSelection extends SelectionAdapter {

		@Override
		public void widgetSelected(SelectionEvent e) {
			int selection = friendsListView.getSelectionIndex();
			friendsListView.remove(selection);
